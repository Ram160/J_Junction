...
$sqlad = "SELECT * FROM adventure WHERE Visibility =1 AND Sno<10";
$checkad = mysqli_query($connection, $sqlad);

$sqldes = "SELECT * FROM destination WHERE Visibility =1 AND Sno<7";
...
<body>
  ...
  background-size: 100% 100%;">
    ...
    <?php
include('admin/config/connection.php');
$sql = "SELECT * FROM hotel WHERE Visibility=1 AND Sno<7 ";
$check = mysqli_query($connection, $sql);
