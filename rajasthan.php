...
$sql = "SELECT * FROM home WHERE Sno=4";
$check = mysqli_query($connection, $sql);
$row = mysqli_fetch_assoc($check);

$sqlf = "SELECT * FROM food WHERE Visibility =1";
$checkf = mysqli_query($connection, $sql);

$sqlad = "SELECT * FROM adventure WHERE Visibility =1 ";
$checkad = mysqli_query($connection, $sqlad);

$sqldes = "SELECT * FROM destination WHERE Visibility =1 AND Sno>12";
